            ...
            switch (tipo.toLowerCase()) {
                case "audio":
                    ...
                    if (volumeInput.length() > 5) {
                        System.out.println("Il volume deve avere al massimo lunghezza 5.");
                        i--;
                    }
                ...
                case "video":
                    ...
                    if (volumeVideoInput.length() > 5) {
                        System.out.println("Il volume deve avere al massimo  5 !");
                        i--;
                        break;
                    }
                    ...
                    System.out.println("Inserisci la luminosità da uno a 5 * ");
                    String lumVideoInput = scanner.nextLine();
                    if (lumVideoInput.length() > 5) {
                        System.out.println("La luminosità deve avere al massimo 5 *");
                        i--;
                        break;
                    }
